...
android {
    namespace = "com.example.translatorapp.android"
    compileSdk = 33
    defaultConfig {
        applicationId = "com.example.translatorapp.android"
        minSdk = 24
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"

        testInstrumentationRunner = "com.example.translatorapp.TestHiltRunner"
    }
    buildFeatures {
        compose = true
    }
