...
import com.example.translatorapp.translate.data.local.FakeHistoryDataSource
import com.example.translatorapp.translate.data.remote.FakeTranslateClient
...
class TranslateViewModelTest {
    ...
    @Test
    fun `State and history are properly combined`() = runBlocking {
